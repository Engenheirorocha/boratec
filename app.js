...
function createBoraTecHome(){
    ...
    style.textContent = `
        ...
        .bt-v182-user-button.bt-v182-user-avatar-only{
            width:auto;
            max-width:none;
            min-width:0;
            padding:0;
        ...
        .bt-v182-user-button.bt-v182-user-avatar-only:hover,
        .bt-v182-user-button.bt-v182-user-avatar-only:focus{
            background:transparent;
        }
    ...
    home.innerHTML = `
        <div class="bt-home-shell">
            ...
            <div class="bt-v182-top">
                ...
                <button
                    id="btHomeUserButton"
                    class="bt-v182-user-button bt-v182-user-avatar-only"
                    type="button"
                    onclick="selectNav(null,'Perfil')"
                    aria-label="Abrir e editar meu perfil"
                    title="Meu perfil"
                >
                    <span
                        id="btHomeAvatar"
...
(function(){
    ...
    style.textContent = `
        ...
        #btHomeScreen .bt-v182-user-button.bt-v182-user-avatar-only{
            border:0 !important;
